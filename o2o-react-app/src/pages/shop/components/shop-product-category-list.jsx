...
class ShopProductCategoryList extends React.PureComponent {
    ...
    render() {
        ...
        return (<React.Fragment>
                                     ...
                                     extra={<Flex>
                                         ...
                                         <Flex.Item>
                                             <Button type="primary" size="small"
                                                     onClick={() => history.push(`/shop/productcategoryoperation/${shopId}/${item.productCategoryId}`)}>编辑</Button>
                                         </Flex.Item>
                                     </Flex>}>
            ...
            <WingBlank size="lg">
                <Button type="primary"
                        onClick={() => this.props.history.push(`/shop/productcategoryoperation/${shopId}`)}> 添加类别 </Button>
            </WingBlank>
        </React.Fragment>)
    }
}
